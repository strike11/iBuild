...
List<Map<String, dynamic>> buildProjectsSeed() {
  ...
  final project = _summarizeProject({
    ...
    'district': 'Chilanzar',
    'address': 'Katartal ko\'chasi, Chilanzar, Tashkent',
    'lat': 41.31215655652716,
    'lng': 69.25275117116448,
    'developer': developer,
    'description':
        'NestOne is a mixed-use complex in Chilanzar: sale and rent apartments '
        'in a 10-storey living tower plus Class-A offices with live availability '
        'on an interactive floor grid. Underground parking, gym, and concierge.',
    'amenities': const [
      'Underground parking',
      'Gym',
      'Concierge',
    ...
    'offers': [
      {
        ...
        'type': 'installment',
        'title': '0% installment until handover',
        'description': '25% down payment, balance in equal monthly payments.',
        'startsAt': null,
        'endsAt': '2027-04-01T00:00:00.000Z',
