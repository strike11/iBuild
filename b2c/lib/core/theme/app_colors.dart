...
/// token set via `context.colors` (see `app_theme_ext.dart`). Swapping the
/// palette later means providing a different [AppColors] instance (see
/// `color_schemes/`) — no widget code changes.
@immutable
