...
class AppNetworkImage extends StatelessWidget {
  ...
  /// Decode-size hint — keeps card thumbnails from decoding full-resolution
  /// gallery photos into GPU memory.
  ...
  /// Web: fetch + decode via [Image.network] (respects [cacheWidth]/[cacheHeight]).
  /// Avoids `CachedNetworkImage` + `flutter_cache_manager` on web, which often
  /// fails for large residence PNGs and lands on the error placeholder even
  /// when the URL is fine. IO keeps disk caching via [CachedNetworkImage].
