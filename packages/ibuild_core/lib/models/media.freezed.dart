...
mixin _$MediaItem {
 ...
 String get id; MediaType get type; String get url; int get sortOrder; bool get isCover;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MediaItem&&(identical(other.id, id) || other.id == id)&&(identical(other.type, type) || other.type == type)&&(identical(other.url, url) || other.url == url)&&(identical(other.sortOrder, sortOrder) || other.sortOrder == sortOrder)&&(identical(other.isCover, isCover) || other.isCover == isCover));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,type,url,sortOrder,isCover);

@override
String toString() {
  return 'MediaItem(id: $id, type: $type, url: $url, sortOrder: $sortOrder, isCover: $isCover)';
}
...
@useResult
$Res call({
 String id, MediaType type, String url, int sortOrder, bool isCover
});
...
/// Create a copy of MediaItem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? type = null,Object? url = null,Object? sortOrder = null,Object? isCover = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  MediaType type,  String url,  int sortOrder,  bool isCover)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MediaItem() when $default != null:
return $default(_that.id,_that.type,_that.url,_that.sortOrder,_that.isCover);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  MediaType type,  String url,  int sortOrder,  bool isCover)  $default,) {final _that = this;
switch (_that) {
case _MediaItem():
return $default(_that.id,_that.type,_that.url,_that.sortOrder,_that.isCover);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  MediaType type,  String url,  int sortOrder,  bool isCover)?  $default,) {final _that = this;
switch (_that) {
case _MediaItem() when $default != null:
return $default(_that.id,_that.type,_that.url,_that.sortOrder,_that.isCover);case _:
  return null;
...
class _MediaItem implements MediaItem {
  const _MediaItem({required this.id, required this.type, required this.url, this.sortOrder = 0, this.isCover = false});
...
/// Create a copy of MediaItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? type = null,Object? url = null,Object? sortOrder = null,Object? isCover = null,}) {
